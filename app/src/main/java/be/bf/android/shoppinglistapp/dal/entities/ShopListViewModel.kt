...
//class ShopListViewModel(application: Application): AndroidViewModel(application) {
    ...
    private val _currentShopList : MutableLiveData<ShopListWithDetail> = MutableLiveData()
    val currentShopList : LiveData<ShopListWithDetail>
    ...
    fun loadShopList(shopList: ShopListWithDetail) {
        _currentShopList.value = shopList
    }
